...
const HabitsPage = () => {
      ...
      <div className={styles.habitsPage}>
        <div className={styles.header}>
          <FadeText
            ...
            duration={600}
          />
          <p className={styles.subtitle}>View and manage this specific habit</p>
        </div>

        <div className={styles.content}>
          <div className={styles.placeholder}>
            <FadeText text='Individual habit details coming soon...' delay={400} duration={600} />
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className={styles.habitsPage}>
      <div className={styles.header}>
        <FadeText text='Your Habits' className={styles.title} delay={100} duration={600} />
        <p className={styles.subtitle}>Manage your daily habits and track progress</p>
      </div>
