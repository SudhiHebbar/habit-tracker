...
describe('CompletionFeedback Component', () => {
  ...
  it('renders success feedback with correct message', () => {
    render(<CompletionFeedback type='success' message='Habit completed successfully!' />);
  ...
  it('renders error feedback with correct message', () => {
    render(<CompletionFeedback type='error' message='Failed to complete habit' />);
  ...
  it('renders offline feedback with correct message', () => {
    render(<CompletionFeedback type='offline' message='Saved locally - will sync when online' />);
  ...
  it('shows habit name when provided', () => {
    render(<CompletionFeedback type='success' message='Completed!' habitName='Morning Exercise' />);

    expect(screen.getByText('Morning Exercise')).toBeInTheDocument();
  });

  it('does not show habit name when not provided', () => {
    render(<CompletionFeedback type='success' message='Completed!' />);
  ...
  it('shows streak when provided and greater than 0', () => {
    render(<CompletionFeedback type='success' message='Great job!' streak={7} />);
  ...
  it('does not show streak when 0', () => {
    render(<CompletionFeedback type='success' message='Great job!' streak={0} />);

    expect(screen.queryByText('🔥')).not.toBeInTheDocument();
  });

  it('does not show streak when not provided', () => {
    render(<CompletionFeedback type='success' message='Great job!' />);

    expect(screen.queryByText('🔥')).not.toBeInTheDocument();
  });

  it('shows particles animation for success type', () => {
    const { container } = render(<CompletionFeedback type='success' message='Success!' />);
  ...
  it('does not show particles for error type', () => {
    const { container } = render(<CompletionFeedback type='error' message='Error!' />);
  ...
  it('does not show particles for offline type', () => {
    const { container } = render(<CompletionFeedback type='offline' message='Offline!' />);
  ...
  it('has close button that calls onHide', async () => {
    ...
    render(
      <CompletionFeedback type='success' message='Success!' onHide={mockOnHide} autoHide={false} />
    );
  ...
  it('uses default auto-hide delay when not specified', async () => {
    ...
    render(<CompletionFeedback type='success' message='Success!' onHide={mockOnHide} />);
  ...
  it('starts with animating state', () => {
    render(<CompletionFeedback type='success' message='Success!' />);
  ...
  it('applies custom className', () => {
    render(<CompletionFeedback type='success' message='Success!' className='custom-feedback' />);
  ...
  it('shows correct icon for error type', () => {
    render(<CompletionFeedback type='error' message='Error!' />);
  ...
  it('shows correct icon for offline type', () => {
    render(<CompletionFeedback type='offline' message='Offline!' />);
  ...
  it('cleans up timers on unmount', () => {
    const { unmount } = render(<CompletionFeedback type='success' message='Success!' />);
