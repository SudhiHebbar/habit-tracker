...
describe('HabitList', () => {
  ...
  describe('Loading State', () => {
    it('should show loading state when loading is true', () => {
      render(<HabitList habits={[]} loading={true} {...mockCallbacks} />);
  ...
  describe('Empty State', () => {
    it('should show empty state when no habits exist', () => {
      ...
      expect(screen.getByText('Create your first habit to start building positive routines.')).toBeInTheDocument();
  ...
  describe('Habit Actions', () => {
    ...
    it('should pass showStats prop to HabitCard components', () => {
      render(<HabitList habits={mockHabits} showStats={true} {...mockCallbacks} />);
