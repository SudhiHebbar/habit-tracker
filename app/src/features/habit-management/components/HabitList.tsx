...
export const HabitList: React.FC<HabitListProps> = ({
  ...
  onDeleteHabit,
  onToggleComplete,
  // onBulkEdit, // Temporarily disabled for bulk edit functionality
  showStats = true,
  viewMode = 'grid',
  className = '',
}) => {
  ...
  // const selectedHabitObjects = filteredAndSortedHabits.filter(h =>
  //   selectedHabits.has(h.id.toString())
  // );
