...
const ICON_LIBRARY: IconOption[] = [
  ...
  },
  {
    ...
    name: 'Sleep',
    category: 'lifestyle',
    svg: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M6 6.08V4h4v2c2.21 0 4 1.79 4 4s-1.79 4-4 4c-1.86 0-3.41-1.28-3.86-3h-3.9C2.75 12.22 2 13.04 2 14c0 .96.75 1.78 1.24 2H6v2h4v-2.08c3.39-.49 6-3.39 6-6.92s-2.61-6.43-6-6.92V2H6v4.08z"/></svg>',
  },
...
export const IconSelector: React.FC<IconSelectorProps> = ({
  ...
  const renderIcon = (icon: IconOption) => (
    <button
      ...
      type='button'
    >
      <div className={styles.iconSvg} dangerouslySetInnerHTML={{ __html: icon.svg }} />
    </button>
  );
