...
describe('CreateTrackerModal Component', () => {
  ...
  it('renders modal when open is true', () => {
    render(<CreateTrackerModal isOpen onClose={mockOnClose} onSubmit={mockOnSuccess} />);
  ...
  it('does not render modal when open is false', () => {
    render(<CreateTrackerModal isOpen={false} onClose={mockOnClose} onSubmit={mockOnSuccess} />);
  ...
  it('shows loading state during submission', () => {
    render(<CreateTrackerModal isOpen onClose={mockOnClose} onSubmit={mockOnSuccess} isCreating />);
  ...
  it('maintains form state when modal is reopened', () => {
    const { rerender } = render(
      <CreateTrackerModal isOpen onClose={mockOnClose} onSubmit={mockOnSuccess} />
    );
    ...
    // Close modal
    rerender(<CreateTrackerModal isOpen={false} onClose={mockOnClose} onSubmit={mockOnSuccess} />);

    // Reopen modal
    rerender(<CreateTrackerModal isOpen onClose={mockOnClose} onSubmit={mockOnSuccess} />);
