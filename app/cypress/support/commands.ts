...
Cypress.Commands.add(
  'createTestTracker',
  (name = 'Test Tracker', description = 'Created for testing') => {
...
Cypress.Commands.add(
  'createTestHabit',
  (trackerName = 'Test Tracker', habitName = 'Test Habit') => {
...
Cypress.Commands.add(
  'testFormValidation',
  (fieldSelector: string, invalidValue: string, expectedError: string) => {
